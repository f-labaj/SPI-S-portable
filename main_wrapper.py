					...
					while True:
						...
						if BBB_event == "Exit" or BBB_event == sg.WIN_CLOSED:
							...
							if len(pattern_list) != 0:
								...
								aux.save_measurements(intensity_vector, './EXAMPLES/intensity_' + str(values["-RESOLUTION-"]) + '_-' + str(values["-FACTOR-"]) + '-')
								...
								aux.save_measurements(intensity_vector, './EXAMPLES/norm_intensity_' + str(values["-RESOLUTION-"]) + '_-' + str(values["-FACTOR-"]) + '-')
